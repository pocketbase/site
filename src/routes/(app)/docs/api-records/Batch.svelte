                ...
                <td>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <br />
                            <em>
                                (if the <code>POST /api/batch</code> call has <code>Authorization</code> header
                                it is forwarded to all batch requests automatically)
                            </em>
                        </li>
                    ...
                    <p>
                        ...
                        submitted as serailized json under the <code>@jsonPayload</code> field and file keys
